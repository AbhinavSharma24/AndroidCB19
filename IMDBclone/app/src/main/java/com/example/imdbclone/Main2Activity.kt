        ...
        service.popularMovies().enqueue(object : Callback<Tmdb2> {
            ...
            override fun onResponse(
                ...
                runOnUiThread {
                    ...
                    rview2.adapter = TmdbAdapter2(this@Main2Activity, response.body()!!.results)
        ...
        service.upcoming().enqueue(object : Callback<Tmdb2> {
            ...
            override fun onResponse(
                ...
                runOnUiThread {
                    ...
                    rview3.adapter = TmdbAdapter(this@Main2Activity, response.body()!!.results)
        ...
        service.toprated().enqueue(object : Callback<Tmdb2> {
            ...
            override fun onResponse(
                ...
                runOnUiThread {
                    ...
                    rview4.adapter = TmdbAdapter2(this@Main2Activity, response.body()!!.results)
                }
            }
        })
